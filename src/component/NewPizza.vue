<template>
	<form>
		...
		<div class="form-group row">
			...
			<div class="col-sm-11">
				<input type="text" class="form-control" v-model="newPizza.name" name="">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-11">
				<input type="text" class="form-control" v-model="newPizza.size1" name="">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-1">价格</label>
			<div class="col-sm-11">
				<input type="text" class="form-control" v-model="newPizza.price1" name="">
			</div>
		</div>
		...
		<div class="form-group row">
			<label class="col-sm-1">尺寸</label>
			<div class="col-sm-11">
				<input type="text" class="form-control" v-model="newPizza.size2" name="">
			</div>
		</div>
		<div class="form-group row">
			<label class="col-sm-1">价格</label>
			<div class="col-sm-11">
				<input type="text" class="form-control" v-model="newPizza.price2" name="">
			</div>
		</div>
	...
	export default{
		...
		methods:{
			addMenuItem() {
				...
				//axios vue-resouce(官方已经不维护) 	es6 fetch
				/*fetch('https://wd3451744778iotmac.wilddogio.com/menu.json',{
					method: "POST",
					headers: {
